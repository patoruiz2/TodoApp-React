      ...
      <ul className=''>
        ...
        <section className='flex justify-center content-center mt-3'>
          <button onClick={deleteAll}
            ...
            w-auto p-2 m-2 text-center font-bold flex items-center '
          >
            <span className='mx-3'>
              Clean
            </span>
    ...
    >
      <nav className='my-6 mx-2 w-full border-b'>
        <ul className='flex flex-row items-center justify-between'>
          <li className='m-4 w-full text-center text-xl'>
      ...
      <div className='flex w-full mx-auto my-3 justify-center md:max-h-28' >
        <input
          type="text"
          className='
        ...
        active:bg-[#4db7d4] md:min-h-full md:w-1/4'
          onClick={handleClick} >
          Submit
        </button>
      </div>
